...
export default {
  ...
  methods: {
    ...
    getBookingScheduleRule() {
      scheduleApi.getScheduelPage( this.hoscode, this.depcode,this.page, this.limit).then(response => {
    ...
    findScheduleList() {
      scheduleApi.getScheduelDetail(this.hoscode, this.depcode, this.workDate).then(response => {
